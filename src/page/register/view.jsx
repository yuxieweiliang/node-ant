...
import { Button, Input, Form, Layout, Menu, Icon, Row, Col, Tooltip, Cascader, SubMenu, Checkbox,  AutoComplete  } from 'antd';
const { Header, Content, Footer, Sider } = Layout;
const FormItem = Form.Item;
const residences = func.residences;
class MyComponent extends React.Component {
  ...
  checkPassword = func.checkPassword.bind(this);
  checkConfirm = func.checkPassword.bind(this);
  handleConfirmBlur = func.handleConfirmBlur.bind(this);
  handleSubmit = func.handleSubmit.bind(this);
  ...
  render() {
    ...
    const prefixSelector = func.prefixSelector.call(this);
    return (<Layout>
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            >
              {getFieldDecorator('website', {
                ...
                <AutoComplete
                  dataSource={func.websiteOptions.call(this)}
                  onChange={func.handleWebsiteChange.bind(this)}
                  placeholder="website"
                >
                  <Input />
                </AutoComplete>
...
const MyComponentForm = Form.create()(MyComponent);
...
if(typeof document !== 'undefined') {
  require('./style.less');
  render(<MyComponentForm/>, document.getElementById('root'));
}

module.exports = MyComponentForm;