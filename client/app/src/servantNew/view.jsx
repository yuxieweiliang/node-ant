      ...
      <Layout style={{ marginLeft: 200}}>
        ...
        <Content className="ant-spin-container" >
          <Form layout="horizontal">
            <Form.Item label="名字" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._nameHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="种族" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._nameHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="契主" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._nameHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="能力" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._nameHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="进化" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._nameHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="形象" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._descriptionHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="形象" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
              <Input onInput={(e) => this._descriptionHandle(e.target.value)} placeholder="Basic usage"/>
            </Form.Item>
            <Form.Item label="背景" {...{labelCol: { span: 4 },wrapperCol: { span: 10 }}}>
            ...
            <Input.TextArea defaultValue="fdsafdsafdafda" onInput={this.textareaChange} cols="30" rows="10"/>
