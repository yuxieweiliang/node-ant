...
const IsomorphicPlugin = require('webpack-isomorphic/plugin');// 消除 require函数差异性
const SaveAssetsJson = require('assets-webpack-plugin');// 资源链接
const OpenBrowserPlugin = require('open-browser-webpack-plugin'); // 用指定浏览器打开项目视图
// nodeJs执行环境
